          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {filtered.map((item, index) => (
              <article key={item.id}>
                ...
                >
                  <div className="relative h-[250px] overflow-hidden rounded-lg border border-[#7d5b2e]/35 bg-[#1a1a1a] sm:h-[240px]">
                    {item.hasImage ? (
                      <>
                        <Image
                          src={item.imageUrl}
        ...
        >
          ...
          {hasPrev && (
            <button
              ...
              className="absolute left-2 top-1/2 z-10 -translate-y-1/2 rounded-full border border-[#7d5b2e]/60 bg-black/70 p-3 text-[#f0dfbf] backdrop-blur-sm transition hover:border-[#bc8f4d] hover:text-[#e7c98a] sm:left-3"
            >
          ...
          {hasNext && (
            <button
              ...
              className="absolute right-2 top-1/2 z-10 -translate-y-1/2 rounded-full border border-[#7d5b2e]/60 bg-black/70 p-3 text-[#f0dfbf] backdrop-blur-sm transition hover:border-[#bc8f4d] hover:text-[#e7c98a] sm:right-3"
            >
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
                <path d="M6 2l6 6-6 6" />
              </svg>
          ...
          <button
            ...
            className="absolute right-3 top-3 z-10 rounded-full border border-[#7d5b2e]/60 bg-black/70 p-2.5 text-[#f0dfbf] backdrop-blur-sm transition hover:border-[#bc8f4d] hover:text-[#e7c98a] sm:right-4 sm:top-4"
          >
